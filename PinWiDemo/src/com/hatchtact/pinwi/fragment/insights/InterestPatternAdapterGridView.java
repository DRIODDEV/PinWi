...
public class InterestPatternAdapterGridView extends BaseAdapter implements Serializable
{
	...
	ArrayList<GetInterestPatternByChildIDOnInsight> getInterestTraitsByChildIDForParticularBucketId;
	...
	public InterestPatternAdapterGridView(Context context, ArrayList<GetInterestPatternByChildIDOnInsight> getInterestTraitsByChildIDOnInsightListForParticularBucketId) 
	{
		super();                  
	...
	public View getView(int position, View convertView, ViewGroup parent) 
	{
		...
		holder.interestDriverName.setTextColor(context.getResources().getColor(R.color.black_color));
		holder.interestDriverDesc.setTextColor(context.getResources().getColor(R.color.black_color));

		holder.interestDriverName.setText(getInterestTraitsByChildIDForParticularBucketId.get(position).getName().toString());
		holder.interestDriverImage.setImageResource(arrayInterestTrendsImages[Integer.parseInt(getInterestTraitsByChildIDForParticularBucketId.get(position).getInterestTraitID().trim())]);
