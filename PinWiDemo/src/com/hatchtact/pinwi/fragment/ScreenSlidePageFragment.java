...
public class ScreenSlidePageFragment extends Fragment {
	...
	private Integer[] arrayImagesTutorial7={R.drawable.screen4,R.drawable.screen2,R.drawable.screen3,R.drawable.screen4,R.drawable.screen1};
	private Integer[] arrayImagesTutorial8={R.drawable.screen1,R.drawable.screen2,R.drawable.screen3,R.drawable.screen4,R.drawable.screen1};
	private Integer[] arrayImagesTutorial9={R.drawable.screen3,R.drawable.screen2,R.drawable.screen3,R.drawable.screen4,R.drawable.screen1};
	private Integer[] arrayImagesTutorial10={R.drawable.screen2,R.drawable.screen2,R.drawable.screen3,R.drawable.screen4,R.drawable.screen1};
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		case 5:
			...
			break;
		case 6:
			image.setImageResource(arrayImagesTutorial7[mPageNumber]);
            sizeArray=arrayImagesTutorial7.length;

			break;

		case 7:
			image.setImageResource(arrayImagesTutorial8[mPageNumber]);
            sizeArray=arrayImagesTutorial8.length;

			break;

		case 8:
			image.setImageResource(arrayImagesTutorial9[mPageNumber]);
            sizeArray=arrayImagesTutorial9.length;

			break;

		case 9:
			image.setImageResource(arrayImagesTutorial10[mPageNumber]);
            sizeArray=arrayImagesTutorial10.length;
