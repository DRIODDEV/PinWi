...
import com.hatchtact.pinwi.fragment.HolidayCalenderFragment;
...
public class ExtendedCalendarView extends RelativeLayout implements OnItemClickListener,OnClickListener
{
	...
	private GetHolidaysByChildIDList getHolidaysByChildIDList;
	...
	/** For Range Selection*/
	public int currentSelectedDate = 0;
	public int justPreviousSelectedDate = 0;
	
	private HolidayCalenderFragment holidayCalenderFragment;
	...
	public void setHolidayCalenderFragmentInstance(HolidayCalenderFragment holidayCalenderFragment)
	{
		this.holidayCalenderFragment= holidayCalenderFragment;
	}
	...
	private void init()
	{
		...
		getHolidaysByChildIDList=new GetHolidaysByChildIDList();
		...
		TypeFace typeFace = new TypeFace(context);
	...
	{
		// TODO Auto-generated method stub
		if(getHolidaysByChildIDList!= null && getHolidaysByChildIDList.getGetHolidaysByChildIDList()!=null)
			getHolidaysByChildIDList.getGetHolidaysByChildIDList().clear();
		
	
		new GetHolidaysByChildIDAsync(month,year).execute();
	...
	public void rebuildCalendar(){
		if(month != null){
			...
			holidayCalenderFragment.setDefaultRangeNotSelected();
	...
	private class GetHolidaysByChildIDAsync extends AsyncTask<Void, Void, Integer>
	{
		private String month;
		private int year;
		
		public GetHolidaysByChildIDAsync(String month, int year) {
		...
		protected void onPreExecute() {
			...
			progressDialogHolidaysByChildID = ProgressDialog.show(context, "", StaticVariables.progressBarText, false);
		...
		protected Integer doInBackground(Void... params)
		{
			...
			{
				getHolidaysByChildIDList =serviceMethod.getHolidaysByChildIDList(StaticVariables.currentChild.getChildID(),month,year);
			}
			else 
			{
				ErrorCode=-1;
		...
		protected void onPostExecute(Integer  result) {
			...
			{
				if(getHolidaysByChildIDList!=null && getHolidaysByChildIDList.getGetHolidaysByChildIDList().size()>0)
				{
					mAdapter.setHolidaysByChildIDList(getHolidaysByChildIDList);
					refreshCalendar();
				}
				else
				{
	...
	*/}
	...
	public CalendarAdapter getCalendarHolidayAdapter()
	{
		return mAdapter;
	}
}
