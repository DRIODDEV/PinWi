...
public class WhatToDoActivityListAdapter extends BaseAdapter
{

	public GetListOfActivitiesOnRecommendedByClusterIDList getListOfActivities;
	...
	public WhatToDoActivityListAdapter(Context context, GetListOfActivitiesOnRecommendedByClusterIDList list, ActivityListFragment networkConnectionsFragment)
	{
	...
	@Override
	public int getCount() {
		if (getListOfActivities.getListOfActivitiesOnRecommendedByClusterID() != null) 
		{
			return getListOfActivities.getListOfActivitiesOnRecommendedByClusterID().size();
		} 
		else 
		{
			return 0;
	...
	@Override
	public GetListOfActivitiesOnRecommendedByClusterID getItem(int position) {

		return getListOfActivities.getListOfActivitiesOnRecommendedByClusterID().get(position);
	}
	...
	public View getView(final int position, View view, ViewGroup parent) 
	{
		...
		GetListOfActivitiesOnRecommendedByClusterID model=getListOfActivities.getListOfActivitiesOnRecommendedByClusterID().get(position);
