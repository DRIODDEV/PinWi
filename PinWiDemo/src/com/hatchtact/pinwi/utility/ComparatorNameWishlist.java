 ...
 */
public class ComparatorNameWishlist implements Comparator<GetListOfWishListsByChildID> 
{



	@Override
	public int compare(GetListOfWishListsByChildID object1, GetListOfWishListsByChildID object2) {
		

        String firstString = object2.getActivityName();
        String secondString = object1.getActivityName();
