...
public class GetFriendsTempleteMessageListByChildID implements Serializable
{
	private String Text;
	...
	public String getColorHeading() {
		return colorHeading;
	}

	public void setColorHeading(String colorHeading) {
		this.colorHeading = colorHeading;
	}
