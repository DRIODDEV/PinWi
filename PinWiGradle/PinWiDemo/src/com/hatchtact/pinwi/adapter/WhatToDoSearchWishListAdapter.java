...
import com.hatchtact.pinwi.classmodel.SearchWishListByChildID;
...
public class WhatToDoSearchWishListAdapter extends BaseAdapter
{

	public SearchWishListByChildIDList searchWishList;
	...
	public WhatToDoSearchWishListAdapter(Context context, SearchWishListByChildIDList list, WishListFragment networkConnectionsFragment)
	{
		// TODO Auto-generated constructor stub
		this.context = context;
		inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		this.searchWishList = list;
	...
	@Override
	public int getCount() {
		if (searchWishList.getsearchWishListByChildIDList() != null) 
		{
			return searchWishList.getsearchWishListByChildIDList().size();
		} 
		else 
		{
			return 0;
	...
	@Override
	public SearchWishListByChildID getItem(int position) {

		return searchWishList.getsearchWishListByChildIDList().get(position);
	}
	...
	public View getView(final int position, View view, ViewGroup parent) 
	{
		...
		SearchWishListByChildID model=searchWishList.getsearchWishListByChildIDList().get(position);
