...
public class AfterSchoolSubCategoryByCatIDAdapter extends ArrayAdapter<AfterSchoolActivityByCatId> implements Filterable
{

	//public ArrayList<AfterSchoolActivityByCatId>  list_categories = new ArrayList<AfterSchoolActivityByCatId>();

	private List<AfterSchoolActivityByCatId> getAlllist_categories=null;
	public List<AfterSchoolActivityByCatId > filteredlist_categories = null;
	
	private LayoutInflater inflater;
	private TypeFace typeFace=null;

	public AfterSchoolSubCategoryByCatIDAdapter(Context context, ArrayList<AfterSchoolActivityByCatId> list)
	{
	...
	@Override
	public AfterSchoolActivityByCatId getItem(int position) {
	...
	public Filter getFilter() {
		Filter filter = new Filter() {
			...
			protected void publishResults(CharSequence constraint,FilterResults results) {
				...
				getAlllist_categories = (ArrayList<AfterSchoolActivityByCatId>) results.values; // has the filtered values
			...
			protected FilterResults performFiltering(CharSequence constraint) {
				...
				ArrayList<AfterSchoolActivityByCatId> FilteredArrList = new ArrayList<AfterSchoolActivityByCatId>();

				if (filteredlist_categories == null) {
					filteredlist_categories = new ArrayList<AfterSchoolActivityByCatId>(getAlllist_categories); // saves the original data in mOriginalValues
				}
