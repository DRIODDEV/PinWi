...
public class FrequencySchoolFragment extends ParentFragment
{
	private View view;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		customDialog=new CustomDialogBiWeekly(FrequencySchoolFragment.this);
	...
	private void setData()
	{
		...
		if(StaticVariables.addSchoolActivities!=null)
		{
			...
			switch (StaticVariables.addSchoolActivities.getFMode())
			{
				case 0:
				...
				case 2:
					...
					BWFMode=StaticVariables.addSchoolActivities.getBWFMode();
					refillActivityDaysData();
					break;
				case 3:
		...
		buttonSave.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				else
				{
					...
					{
						StaticVariables.addSchoolActivities.setFMode(modeAllDays);
					}
					else if(checkBoxWeekly.isChecked())
					{
						StaticVariables.addSchoolActivities.setFMode(modeWeekly);
						addDaySelected();
					}
					else if(checkBoxBiWeekly.isChecked())
					{
						StaticVariables.addSchoolActivities.setFMode(modeBiWeekly);
						addDaySelected();
						StaticVariables.addSchoolActivities.setBWFMode(BWFMode);
					}
	...
	private void addDaySelected()
	{
		...
		StaticVariables.addSchoolActivities.setActivityDays(days);
