...
public class Day{
	...
	int colorChanged = 0;
	/** Indicates that this Holiday day is selected...comes from webservice..*/
	public boolean setDayForHolidayCalendar;
	
	/** 1 -> not editable */
	public boolean canHolidatBeEditted;
	
	/** true -> Selected from range */
	public boolean isSelectedFromRange;
	...
	public Day(Context context,int day, int year, int month){
		...
		setDayForHolidayCalendar = false;
		canHolidatBeEditted = true;
		isSelectedFromRange = false;
	}
